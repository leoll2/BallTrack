...
#include "serial.h"		// debug purposes
#include "servo.h"
...
uint16_t servo0_rest_pulse_ms = 1310; 	// pulse to stay in rest position
uint16_t servo0_max_offset_ms = 290; 	// pulse range (from rest position)

// Servomotor 1 (short side of 'ball and plate') -> limits 1200, 1850
uint16_t servo1_rest_pulse_ms = 1550; 	// pulse to stay in rest position
uint16_t servo1_max_offset_ms = 300; 	// pulse range (from rest position)
